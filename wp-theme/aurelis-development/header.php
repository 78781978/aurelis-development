...
<link rel="preload" href="<?php echo esc_url( AURELIS_URI . '/assets/fonts/montserrat-500-700-latin.woff2' ); ?>" as="font" type="font/woff2" crossorigin>
...
<link rel="preload" href="<?php echo esc_url( AURELIS_URI . '/assets/fonts/poppins-400-latin.woff2' ); ?>" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="<?php echo esc_url( AURELIS_URI . '/assets/fonts/poppins-600-latin-ext.woff2' ); ?>" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="<?php echo esc_url( AURELIS_URI . '/assets/fonts/poppins-600-latin.woff2' ); ?>" as="font" type="font/woff2" crossorigin>
<?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
