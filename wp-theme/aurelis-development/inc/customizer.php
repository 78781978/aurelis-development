...
function aurelis_customize_register( $wp_customize ) {
	...
	$fields = array(
		...
		'aurelis_map_embed_url'  => array(
			'label'   => 'Adres URL mapy (Google Maps embed)',
			'default' => 'https://www.google.com/maps?q=50.171302,19.967697&z=16&output=embed',
		),
...
function aurelis_company( $key ) {
	$defaults = array(
		...
		'map_embed_url'  => 'https://www.google.com/maps?q=50.171302,19.967697&z=16&output=embed',
